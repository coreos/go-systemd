...
func NewSystemdConnection() (*Conn, error) {
	return NewConnection(func() (*dbus.Conn, error) {
		...
		return dbusAuthConnection(func(...dbus.ConnOption) (*dbus.Conn, error) {
...
func dbusAuthConnection(createBus func(...dbus.ConnOption) (*dbus.Conn, error)) (*dbus.Conn, error) {
	conn, err := createBus()
	if err != nil {
		return nil, err
	}
...
func dbusAuthHelloConnection(createBus func(...dbus.ConnOption) (*dbus.Conn, error)) (*dbus.Conn, error) {
